...
export default function ProjMang() {
    ...
    {/* Add your additional content here */}
            ...
            <ul className="flex items-center animate-fade-right animate-ease-in">
              ...
              <li>
                <a href="/" className="text-xl font-helvetica drop-shadow-md text-main-brown m-10 hover:bg-hover-resume hover:text-text-pink rounded-full px-4 py-2 transform hover:scale-105 transition-all duration-500">Home</a>
            </li>
              <li>
