...
export default function ProjMang() {
    return (
        ...
        <div id="projheader" class="w-screen items-center flex gap-y-3 rounded-3xl gap-9">
            <div id="proj-text" className="columns-4 flex items-center flex-col justify-center w-54 py-8 gap-5">
