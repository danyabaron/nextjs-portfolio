...
export default function ProjMang() {
    return (
        ...
        <div id="goal" className="flex flex-row items-center justify-start ml-12 w-screen mb-9 px-9 gap-12">
        ...
        <div id="research" className="flex flex-row items-center justify-start ml-12 w-screen mb-9 px-9 gap-11">
